...
class FlextCliUtilitiesRuntimeWindowsJobStateMixin:
    ...
    @staticmethod
    def _windows_job_active_count(job_handle: int) -> p.Result[int]:
    ...
    @staticmethod
    def _windows_job_terminate(job_handle: int, exit_code: int) -> str | None:
    ...
    @staticmethod
    def _windows_job_close(job_handle: int) -> str | None:
