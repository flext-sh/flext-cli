    ...
    def get_system_paths(self) -> r[Mapping[str, t.Cli.JsonValue]]:
        ...
        try:
            ...
            serialized_paths: Sequence[t.Cli.JsonValue] = [
                dict(path_info.model_dump()) for path_info in paths_data
            ]
