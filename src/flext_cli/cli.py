...
Current Command Structure:
    ...
    - algar: ALGAR project-specific commands (Sprint 5)
    - gruponos: GrupoNos project-specific commands (Sprint 5)
...
Usage Examples:
    ...
    $ flext auth login --username admin  # Authenticate with username
