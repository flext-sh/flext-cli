...
class FlextCliConstants(FlextConstants):
    ...
    # =========================================================================
    # NAMESPACE: .Cli - All CLI domain constants
    # =========================================================================

    class Cli:
        """CLI domain constants namespace.

        All CLI-specific constants are organized here for better namespace
        ...
        class ErrorMessages:
            ...
            USERNAME_PASSWORD_REQUIRED: Final[str] = (
            ...
            COMMAND_REGISTRATION_FAILED: Final[str] = (
            ...
            UNSUPPORTED_FORMAT_TYPE: Final[str] = (
                "Unsupported format type: {format_type}"
            )
            CREATE_FORMATTER_FAILED: Final[str] = "Failed to create formatter: {error}"
            CREATE_RICH_TABLE_FAILED: Final[str] = (
            ...
            CONFIRMATION_PROMPT_FAILED: Final[str] = (
            ...
            FAILED_STORE_CREDENTIALS: Final[str] = (
            ...
            FAILED_CLEAR_CREDENTIALS: Final[str] = (
            ...
            NO_PLUGIN_CLASS_FOUND: Final[str] = (
                "No plugin class found in module '{module}'"
            )
        ...
        class ServiceMessages:
            ...
            FLEXT_CLI_DEBUG_OPERATIONAL: Final[str] = (
                "FlextCliDebug service operational"
            )
        ...
        class LogMessages:
            ...
            CONFIG_VALIDATION_RESULTS: Final[str] = (
                "Config validation results: {results}"
            )
            CONFIG_EDIT_COMPLETED: Final[str] = (
        ...
        class CoreServiceLogMessages:
            ...
            SERVICE_INFO_COLLECTION_FAILED: Final[str] = (
                "Service info collection failed"
            )
        ...
        class FileErrorMessages:
            ...
            TEMP_DIR_CREATION_FAILED: Final[str] = (
            ...
            FILE_EXISTENCE_CHECK_FAILED: Final[str] = (
                "File existence check failed: {error}"
            )
            UNSUPPORTED_FORMAT_GENERIC: Final[str] = (
        ...
        class ContextErrorMessages:
            ...
            CONTEXT_DEACTIVATION_FAILED: Final[str] = (
                "Context deactivation failed: {error}"
            )
            ...
            VARIABLE_VALUE_MUST_BE_STRING: Final[str] = (
        ...
        class PromptsMessages:
            ...
            USER_SELECTION_LOG: Final[str] = (
                "User selected: {message}, choice: {choice}"
            )
        ...
        class PromptsErrorMessages:
            ...
            CHOICE_REQUIRED: Final[str] = (
                "Choice required. Available choices: {choices}"
            )
            ...
            PROGRESS_PROCESSING_FAILED: Final[str] = (
        ...
        class ModelsErrorMessages:
            ...
            DURATION_CANNOT_BE_NEGATIVE: Final[str] = (
        ...
        class DebugInfoDescriptions:
            ...
            CONFIG_INFO: Final[str] = (
                "Configuration information (sensitive data masked)"
            )
