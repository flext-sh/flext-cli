...
class FlextCliConstants(FlextConstants):
    class Cli:
        ...
        class ValidationLists:
            OUTPUT_FORMATS = ["json", "yaml", "csv", "table", "plain"]
            COMMAND_STATUSES = [
                "pending",
                "running",
                "completed",
            ...
            SESSION_STATUSES = ["active", "completed", "terminated"]
        ...
        class CliParamsDefaults:
            VALID_LOG_FORMATS = ["compact", "detailed", "full"]
            VALID_OUTPUT_FORMATS = ["table", "json", "yaml", "csv", "plain"]
        ...
        class FileSupportedFormats:
            JSON, YAML = ("json", "yaml")
            SUPPORTED_FORMATS = ["json", "yaml", "yml", "txt", "csv"]
            YAML_EXTENSIONS_SET = {".yaml", ".yml"}
