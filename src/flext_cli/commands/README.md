...
- Project-specific commands:
  - `projects/algar.py` - ALGAR integration (Sprint 9)
  - `projects/gruponos.py` - GrupoNos integration (Sprint 9)
...
#### **9.1 ALGAR Integration (`projects/algar.py`)**

```python
@click.group()
def algar():
    """ALGAR project operations."""
    pass

@algar.command()
def migration():
    """ALGAR migration operations."""
    # ALGAR-specific functionality
```
...
7. **ALGAR Commands** - Project-specific operations
8. **GrupoNos Commands** - Project-specific operations
