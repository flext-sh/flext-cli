...
class FlextCliConstants:
    ...
    # FIXED: Use computed fields as single source of truth - evaluate dynamically
    DEFAULT_API_URL: str = str(HTTP.default_api_url)
    ...
    ENV_PREFIX: Final[str] = SYSTEM.env_prefix
    DEFAULT_EDITOR: Final[str] = SYSTEM.default_editor
    PROJECT_VERSION: Final[str] = SYSTEM.project_version
    EDITOR_COMMAND: str = str(SYSTEM.editor_command)
