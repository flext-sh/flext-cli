...
class FlextCliConfigs(FlextConfig):
    ...
    def _cache_dir() -> Path:
        ...
        return FlextCliConfigs._base_dir() / "cache"

    @staticmethod
    def _log_dir() -> Path:
        """Log directory for CLI operations."""
        return FlextCliConfigs._base_dir() / "logs"

    @staticmethod
    def _data_dir() -> Path:
        """Data directory for CLI operations."""
        return FlextCliConfigs._base_dir() / "data"
    ...
    def sync_api_fields(self) -> FlextCliConfigs:
    ...
    def get_global_instance(cls) -> FlextCliConfigs:
        ...
        with CLI-specific settings while preserving FlextCliConfigs defaults
        ...
        # Remove fields that should use FlextCliConfigs defaults or environment variables
    ...
    def load_from_profile(cls, profile_name: str) -> FlextResult[FlextCliConfigs]:
        ...
        if not profile_name or not profile_name.strip():
            return FlextResult[FlextCliConfigs].fail("Profile name cannot be empty")
