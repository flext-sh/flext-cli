...
**9.1 ALGAR Integration**

```bash
flext algar migration status          # ALGAR migration operations
flext algar oud sync                  # Oracle Unified Directory sync
flext algar pipeline deploy          # ALGAR pipeline deployment
```

**9.2 GrupoNos Integration**

```bash
flext gruponos pipeline deploy        # GrupoNos pipeline deployment
flext gruponos config validate       # Configuration validation
flext gruponos monitor status        # Status monitoring
```
