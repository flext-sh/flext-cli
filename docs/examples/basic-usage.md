...
# Run ALGAR migration
poetry run flext algar migrate

# Check migration status
poetry run flext algar status

# Validate ALGAR setup
poetry run flext algar validate
```

### GrupoNos Project

```bash
# GrupoNos commands help
poetry run flext gruponos --help

# Deploy GrupoNos services
poetry run flext gruponos deploy

# Check deployment status
poetry run flext gruponos status

# View service logs
poetry run flext gruponos logs --service api
```
