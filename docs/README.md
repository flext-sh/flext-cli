...
- [Project Integrations](integration/projects.md) - Project-specific integrations (ALGAR, GrupoNos, Meltano)
...
- **Project Integration**: ALGAR, GrupoNos, and Meltano support
