...
2. `src/flext_cli/__init__.py` exports
3. Module docstrings
...
- Primary facades: `FlextCli`, `FlextCliConstants`, `FlextCliModels`, `FlextCliProtocols`, `FlextCliServiceBase`, `FlextCliSettings` (+2 more)
