...
- **Core CLI Projects**: flext-cli (self), algar-oud-mig CLI, gruponos-meltano-native CLI
...
- **algar-oud-mig**: ALGAR project CLI (MUST use flext-cli, NO direct Click/Rich)
- **gruponos-meltano-native**: GrupoNos CLI (MUST use flext-cli, NO direct Click/Rich)
...
- algar-oud-mig: NOT COMPLIANT - has direct Click imports (VIOLATION)
- gruponos-meltano-native: NOT COMPLIANT - has direct Rich imports (VIOLATION)
