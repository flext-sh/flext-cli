...
def test_cli_command_handler_protocol() -> None:
    ...
    class TestCommandHandler:
        def __call__(self, **kwargs: object) -> FlextResult[FlextCliTypings.CliCommandResult]:
            return FlextResult[FlextCliTypings.CliCommandResult].ok({"status": "success"})
...
def test_cli_formatter_protocol() -> None:
    ...
    class TestFormatter:
        def format_data(self, data: FlextCliTypings.CliFormatData, **options: object) -> FlextResult[str]:
...
def test_cli_config_provider_protocol() -> None:
    ...
    class TestConfigProvider:
        ...
        def save_config(self, config: FlextCliTypings.CliConfigData) -> FlextResult[None]:
...
def test_cli_authenticator_protocol() -> None:
    ...
    class TestAuthenticator:
        def authenticate(self, credentials: FlextCliTypings.CliConfigData) -> FlextResult[str]:
