...
if TYPE_CHECKING:
    ...
    from tests.unit.test_constants import TestsCliConstants, TestsCliConstants as c
    ...
    from tests.unit.test_protocols import TestsCliProtocols, TestsCliProtocols as p
