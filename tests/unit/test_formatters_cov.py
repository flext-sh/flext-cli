...
(``print``/``render_rule``/``render_panel``/``render_table``), which delegate
through ``FlextCliFormatters`` and ``FlextCliUtilitiesFormatters``:
...
class TestsFlextCliFormattersCov:
    ...
    def test_print_renders_message_to_stdout(
        ...
        """Render each message and optional style to standard output."""
    ...
    def test_render_rule_renders_label_to_stdout(
        ...
        """Render a visible horizontal rule carrying the supplied label."""
    ...
    def test_render_panel_renders_content_to_stdout(
        ...
        """Render panel content and its title through the public facade."""
    ...
    def test_render_table_renders_columns_and_cells(
        ...
        """Render every declared column and cell through the public facade."""
        cli.render_table(
