...
class TestDebugConnectivity:
    ...
    def test_connectivity_connection_error(
        self,
        mock_failing_api_client: object,  # noqa: ARG002
    ) -> None:
    ...
    def _test_connectivity_connection_error_impl(
        self,
        mock_client_class: MagicMock,  # noqa: ARG002
    ) -> None:
        """Test connectivity with connection error."""
    ...
    def test_connectivity_os_error(self, mock_failing_api_client: object) -> None:  # noqa: ARG002
