...
class TestEnvironmentOverrides:
    ...
    def test_load_env_overrides_with_flext_vars(self) -> None:
        ...
        if "test_var" in overrides or "FLEXT_TEST_VAR" in overrides:
            assert overrides.get("test_var") == "test_value" or overrides.get("FLEXT_TEST_VAR") == "test_value"
    ...
    def test_load_env_overrides_multiple(self) -> None:
        ...
        flext_keys = [k for k in overrides.keys() if "debug" in k.lower() or "log" in k.lower()]
...
class TestAutoConfig:
    ...
    def test_flext_cli_auto_config_with_file(self, mock_load_file: MagicMock, mock_env: MagicMock) -> None:
    ...
    @patch("flext_cli.core.utils._load_env_overrides")
    @patch("flext_cli.core.utils._load_config_file")
    def test_flext_cli_auto_config_file_error(self, mock_load_file: MagicMock, mock_env: MagicMock) -> None:
        """Test auto config when config file fails to load."""
        mock_load_file.return_value = FlextResult[dict[str, object]].fail("File not found")
...
class TestRequireAll:
    ...
    @patch("flext_cli.core.utils.cli_confirm")
    def test_flext_cli_require_all_confirmation_error(self, mock_confirm: MagicMock) -> None:
...
class TestFileOperations:
    ...
    def test_flext_cli_save_file_json(self) -> None:
        ...
        with tempfile.NamedTemporaryFile(suffix=".json", delete=False) as temp_file:
            ...
            with open(temp_path) as saved_file:
