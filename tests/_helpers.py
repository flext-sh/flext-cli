...
def create_test_cli_command(**overrides: dict[str, Any]) -> m.Cli.CliCommand:
...
def create_test_cli_session(**overrides: dict[str, Any]) -> m.Cli.CliSession:
...
class AuthHelpers:
    ...
    @staticmethod
    def create_test_credentials(**overrides: dict[str, Any]) -> dict[str, Any]:
